...
function Home() {
  ...
  const faqs = [
    {
      question: "Who is Coach Dev Kumar?",
      answer:
        "Coach Dev Kumar is a Life & Business Coach focused on mindset mastery, leadership, and personal transformation.",
    },
    {
      question: "What services does he offer?",
      answer:
        "He offers coaching programs, seminars, workshops, and online courses for personal and professional growth.",
    },
    {
      question: "How can I connect with him?",
      answer:
        "You can connect through social media platforms like Instagram, YouTube, LinkedIn, and Facebook.",
    },
  ];
  ...
  return (
    <>
      <div>
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 px-2">
            ...
            <div className="bg-white rounded-md shadow-lg p-3 md:p-2 border-l-4 border-[#D4AF37]">
              ...
              <p className="mx-2 my-2 text-black text-sm md:text-md font-montserrat leading-relaxed">
                ...
                <button className="text-blue-500 hover:border-b hover:border-blue-300">
                  Read more
                </button>
              </p>
            </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-4">
            ...
            <div className="flex items-center gap-6 mt-10">
              <div className="w-24 h-24 bg-[#3b5998] flex items-center justify-center rounded-xl hover:scale-110 transition">
                <i className="fab fa-facebook-f text-white text-5xl"></i>
              </div>

              <div className="w-24 h-24 bg-[#1DA1F2] flex items-center justify-center rounded-xl hover:scale-110 transition">
                <i className="fab fa-twitter text-white text-5xl"></i>
              </div>

              <div className="w-24 h-24 bg-[#0077B5] flex items-center justify-center rounded-xl hover:scale-110 transition">
                <i className="fab fa-linkedin-in text-white text-5xl"></i>
              </div>

              <div className="w-24 h-24 bg-[#262626] flex items-center justify-center rounded-xl hover:scale-110 transition">
                <i className="fab fa-instagram text-white text-5xl"></i>
              </div>

              <div className="w-24 h-24 bg-[#FF0000] flex items-center justify-center rounded-xl hover:scale-110 transition">
        ...
        <section
          ref={faqRef}
          className="py-16 bg-gradient-to-b from-slate-800 to-slate-900"
        >
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="max-w-xl mx-auto mt-10">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  className="border border-slate-700 bg-slate-800 rounded-lg mb-2 overflow-hidden"
                >
                  <button
        ...
        <footer className="bg-indigo-900 text-white py-6 text-center text-sm">
          <div>
            &copy; {new Date().getFullYear()} Coach Dev Kumar • Built with ❤️ by
            Dhruvin Patel •
            <a
              href="https://github.com/Dhruvin2910/motivation-hub"
              target="_blank"
              rel="noreferrer"
